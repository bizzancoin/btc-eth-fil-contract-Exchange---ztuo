...
public class DataRepository implements DataSource {
    ...
    @Override
    public void myInviteInfo(String token, DataCallback dataCallback){
        if (isLocal) mLocalDataSource.myInviteInfo(token, dataCallback);
        else mRemoteDataSource.myInviteInfo(token, dataCallback);
    }
}
