...
//                WonderfulStringUtils.isEmpty(amount) || WonderfulStringUtils.isEmpty(fee) || WonderfulStringUtils.isEmpty(code)) {
                WonderfulStringUtils.isEmpty(amount) || WonderfulStringUtils.isEmpty(fee)) {
            ...
            presenter.extract(SharedPreferenceInstance.getInstance().getTOKEN(), unit, amount, fee, remark, jyPassword, address, "");
        }
    }
