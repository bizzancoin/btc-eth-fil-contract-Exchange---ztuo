...
export const countNotHandle = data => post('admin/finance/member-deposit/count-not-handle', data);
...
export const querySets = data => post('admin/second/set/page-query', data);
export const addSets = data => post('admin/second/set/add', data);
export const updateSets = data => post('admin/second/set/alter', data);
export const delSets = data => post('admin/second/set/delete', data);

export const queryCycles = data => post('admin/second/cycle/page-query', data);
export const addCycles = data => post('admin/second/cycle/add', data);
export const updateCycles = data => post('admin/second/cycle/alter', data);
export const delCycles = data => post('admin/second/cycle/delete', data);
export const querySecondOrderList = data => post('admin/second-order/page-query', data);
//POST获取 "永续合约"=>"交易对管理"=>"获取交易对列表"
export const querySecondCoinList = data => post('admin/second-coin/page-query', data);

//POST获取 "永续合约"=>"交易对管理"=>"新增交易对"
export const addSecondCoin = data => post('admin/second-coin/add', data);

//POST获取 "永续合约"=>"交易对管理"=>"更新交易对"
export const alterSecondCoin = data => post('admin/second-coin/alter', data);

export const querySecondAccounts = data => post('admin/second/account/page-query', data);
export const setClosePresetPrice = data => post('admin/second-order/alter', data);

export const auditDeposit = data => post('admin/finance/member-deposit/audit', data);