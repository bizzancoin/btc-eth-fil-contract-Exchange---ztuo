    ...
    <div class="main-header-con" :style="{paddingLeft: shrink?'60px':'170px'}">
      <div class="main-header" style="border-bottom: none;">
        ...
        <div class="header-avator-con">
          <audio id="musicid" src="./13716.wav" preload="preload" autoplay="autoplay"></audio>
...
import {countNotHandle} from '@/service/getData';
...
function autoPlayMusic() {
  ...
  function musicInBrowserHandler() {
    musicPlay(true);
    documont.body.removeEventListener('touchstart', musicInBrowserHandler);
  }
