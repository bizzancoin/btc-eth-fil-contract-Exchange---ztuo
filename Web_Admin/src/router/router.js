...
let findSlideArr = [
    ...
    // { id: 263, path: 'secondSet', icon: 'document', component: resolve => { require(['@/views/second/Set.vue'], resolve) }},
    // { id: 267, path: 'secondCycle', icon: 'document', component: resolve => { require(['@/views/second/Cycle.vue'], resolve) }},
    // { id: 271, path: 'secondCoin', icon: 'document', component: resolve => { require(['@/views/second/Coin.vue'], resolve) }},
    // { id: 278, path: 'secondOrder', icon: 'document', component: resolve => { require(['@/views/second/Order.vue'], resolve) }},
    // { id: 271, path: 'secondCoin', icon: 'document', component: resolve => { require(['@/views/second/coin.vue'], resolve) }},
    // { id: 276, path: 'financeAccount', icon: 'document', component: resolve => { require(['@/views/financeSecond/account.vue'], resolve) }},
    // { id: 277, path: 'financeOrder', icon: 'document', component: resolve => { require(['@/views/financeSecond/order.vue'], resolve) }},
    // { id: 282, path: 'secondAccount', icon: 'document', component: resolve => { require(['@/views/second/account.vue'], resolve) }}
]
