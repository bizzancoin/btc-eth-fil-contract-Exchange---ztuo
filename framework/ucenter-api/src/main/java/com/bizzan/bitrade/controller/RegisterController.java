...
public class RegisterController {
    ...
    // 邮件配置
    private IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI5tCiRGdPhVAreFEaESto", "ecfLCjVP6PTxgyt7Rwhg54XXX6kBuZ");
...
//    }
    ...
    public String activate(String key, HttpServletRequest request) throws Exception {
        ...
        member.setAvatar("https://gibx.oss-cn-hongkong.aliyuncs.com/defaultavatar.png"); // 默认用户头像
