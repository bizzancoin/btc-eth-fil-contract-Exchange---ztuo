    ...
    public void syncKLine(){
        ...
        for(CoinSyncItem coinItem : coinList) {
            for(String period : PERIOD) {
                ...
                if(period.equals("1min") && timeGap >= 60 * 2) { // 超出1分钟
                    if(fromTime == 0) {
                ...
                if(period.equals("5min") && timeGap >= 60 * 5 * 2) { // 超出5分钟
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("15min") && timeGap >= (60 * 15 * 2)) { // 超出15分钟
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("30min") && timeGap >= (60 * 30 * 2)) { // 超出30分钟
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("60min") && timeGap >= (60 * 60 * 2)) { // 超出60分钟
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("4hour") && timeGap >= (60 * 60 * 4 * 2)) { // 超出4小时
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("1day") && timeGap >= (60 * 60 * 24 * 2)) { // 超出24小时
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("1week") && timeGap >= (60 * 60 * 24 * 7 * 2)) { // 超出24小时
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
                ...
                if(period.equals("1mon") && timeGap >= (60 * 60 * 24 * 30 * 2)) { // 超出24小时
                    if(fromTime == 0) {
                        // 初始化K线，获取最近600根K线
