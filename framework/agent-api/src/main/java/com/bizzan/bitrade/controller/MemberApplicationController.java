...
import com.bizzan.bitrade.model.MemberApplicationScreen;
...
//    @RequiresPermissions("member:member-application:page-query")
    ...
    public MessageResult queryPage(PageModel pageModel,
                                   MemberApplicationScreen screen,
        ...
        booleanExpressions.add(memberApplication.member.inviterId.eq(user.getId()));
