...
public class MessageHelpActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public MessageHelpActivity_ViewBinding(MessageHelpActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MessageHelpActivity_ViewBinding(MessageHelpActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MessageHelpActivity target = this.target;
