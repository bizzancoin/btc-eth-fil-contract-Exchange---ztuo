...
- (void)getData{
    ...
    NSDictionary *param = @{@"pageNo":[NSNumber numberWithInteger:_page], @"pageSize": @"10", @"cate":self.cate,@"lang":[ChangeLanguage networkLanguage]};
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        _tableView.backgroundColor = kRGBColor(18, 22, 28);
