...
//  Copyright © 2019年 liyang. All rights reserved.
//
...
- (void)setSubViewFrame{
    ...
    self.contentView.mj_y=self.contentView.mj_y-30;//改变contentViewY坐标
...
- (void)setupTitleLabel:(NSString *)titleStr{
    ...
    //
    self.titleLabel.frame = CGRectMake(0, contentHeight , width, fontSize);
