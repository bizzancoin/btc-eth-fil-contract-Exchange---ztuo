...
//币竞猜回调
typedef void(^CoinguessingSelecteComplet)(NSString *startTime,NSString *endTime, NSString *symbol,NSString *Periodstr);
...
@property (nonatomic, copy) CoinguessingSelecteComplet CoinguessingBlock;
