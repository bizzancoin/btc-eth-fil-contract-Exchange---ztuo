...
+(void)showTransformLoding:(NSString*)text{
    UIView *superView = [EasyShowUtils topViewController].view ;
    if ([EasyShowOptions sharedEasyShowOptions].lodingShowOnWindow) {
    ...
    EasyShowLodingView *showView = [[EasyShowLodingView alloc] initWithFrame:CGRectZero];
    showView.showText = text ;
    showView.showImageName = nil ;
    [showView showViewWithSuperView:superView];
    showView.transform = CGAffineTransformMakeRotation(90 * M_PI/180.0);
