<template>
  <div class="login_form app-download">
    ...
    <div class="section" id="page4">
      <ul>
        <li>
          <div><img src="https://coingod.oss-cn-hongkong.aliyuncs.com/2019/08/08/download1.png" alt=""></div>
          <p class="title">Extreme Experience</p>
          <p>Meticulously optimized interface display, experience smooth operation response</p>
        </li>
        <li>
          <div><img src="https://coingod.oss-cn-hongkong.aliyuncs.com/2019/08/08/download2.png" alt=""></div>
          <p class="title">Currency Quotes</p>
          <p>Support MACD, KDJ, RSI, BOLL and other professional indicators</p>
        </li>
        <li>
          <div><img src="https://coingod.oss-cn-hongkong.aliyuncs.com/2019/08/08/download5.png" alt=""></div>
          <p class="title">Currency Transaction</p>
          <p>Support two methods of limit order and market order</p>
        </li>
        <li>
          <div><img src="https://coingod.oss-cn-hongkong.aliyuncs.com/2019/08/08/download3.png" alt=""></div>
          <p class="title">Fiat currency transaction</p>
          <p>Quality acceptors, to ensure the smooth flow of funds</p>
        </li>
        <li>
          <div><img src="https://coingod.oss-cn-hongkong.aliyuncs.com/2019/08/08/download4.png" alt=""></div>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://coingod.oss-cn-hongkong.aliyuncs.com/2019/08/08/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "zh_CN" ? "APP下载 - " : "APP Download - ") + "DLE | Global digital currency trading platform";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://coingod.oss-cn-hongkong.aliyuncs.com/appdownload/DLE.apk";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
