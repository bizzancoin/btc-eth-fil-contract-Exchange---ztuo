<template>
  <div class="pdf">
    <embed src="https://coingod.oss-cn-hongkong.aliyuncs.com/BIZZANWhitePaperVer%201.0.pdf" width="100%" height="800">
...
export default {
  data() {
    return {
      src: 'https://coingod.oss-cn-hongkong.aliyuncs.com/BIZZANWhitePaperVer%201.0.pdf'
    };
  },
  created: function() {
    this.init();
