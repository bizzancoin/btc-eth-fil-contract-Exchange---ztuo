module.exports = {
    ...
    sectionPage: {
        ...
        brandTitle: "About bizzans.com",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "bizzans.com was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "bizzans.com is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "bizzans.com Official Customer Service",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by bizzans.com, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        activitystatus0: "temporary",
        activitystatus1: "Not deployed",
        activitystatus2: "Deployed",
        activitystatus3: "Revoked",
        activitystatus4: "Pending",
        activitystatus5: "Deal done",
        activitystatus6: "Revoked",
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of bizzans.com.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC webbizzans.com",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with bizzans.com trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, bizzans.com launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext8: "7、TOP10 or TOP100 will be awarded additional incentives by MKWORLDS from time to time.",
        ruletext9: "8、If other activities are in conflict with the activities of the Promotion Partner, the Partners will be expected to understand whether to change temporarily after consultation.",
        ...
        ruletext11: "9、The right of final interpretation of this activity belongs to bizzans.com.",
        ...
        thanks: "Thank you for supporting bizzans.com！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@bizzans.com, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to bizzans.com.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become bizzans.com Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "bizzans.com APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "bizzans.com is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of bizzans.com come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "bizzans.com platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, bizzans.com adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "bizzans.com strictly screens high-quality projects and provides secure and stable asset hosting services. bizzans.com upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "bizzans.com Community",
        wechat: "Wechat",
        addwechat: "Add 'bizzans.com01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "bizzans.com account registration",
        ...
        fenpeijizhi: 'A description of the bizzans.com income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, bizzans.com will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
