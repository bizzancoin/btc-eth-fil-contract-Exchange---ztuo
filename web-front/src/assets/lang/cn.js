module.exports = {
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归bizzans.com官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与bizzans.com",
        tipsmobile1: "请在电脑端打开bizzans.com并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"bizzans.com的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与bizzans.com交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，bizzans.com推出【推广合伙人】计划，该活动长期有效。",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由bizzans.com官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
    ...
    index: {
        ...
        fenpeijizhi: '关于收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，会拿出平台的80% (扣除税费后) 的收入分配给持有者，20%的收入用来支持平台的研发及运营。",
