module.exports = {
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于BTXCHAIN",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "BTXCHAIN自2021年成立以来，全球超过上百万高端用户使用并作为他们的投资的主要平台。BTXCHAIN总部位于美国芝加哥，受到美国证券交易委员会（SEC），美国商品期货交易委员会（CFTC），金融犯罪执法局（FinCEN），美国财政部海外资产管理办公室（OFAC）监管，是目前全球著名的数字资产国际站。BTXCHAIN旨在向全球提供广泛的数字货币交易、区块链教育、区块链项目孵化、区块链资产发行平台、区块链研究院以及区块链公益慈善等服务。目前，用户覆盖全球207个国家和地区。BTXCHAIN自2021年创立，目前已经获得UBS、Hotmail、BaiDu、Tesla、GoldmanInvestBank等世界顶级企业的投资。BTXCHAIN始终坚持将用户利益放在第一位，致力于为全球高端投资者提供安全、公平、开放、高效的区块链数字资产交易平台。",
        brandDesc2: "BTXCHAIN定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "BTXCHAIN官方新手入门辅助通道",
        oneminutebuy: "币币交易",
    ...
    ctc: {
        ...
        desc:"由BTXCHAIN平台托管数字资产，保障用户资产安全",
        buyin: "买入",
        sell: "卖出",
        buyprice: "买入价",
        sellprice: "卖出价",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归BTXCHAIN官方所有",
        inputamount: "输入兑换数量",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"BTXCHAIN的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与BTXCHAIN交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，BTXCHAIN推出【推广合伙人】计划，该活动长期有效。",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由BTXCHAIN官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归BTXCHAIN所有。",
        pt_card_day: "天",
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "BTXCHAINAPP - 全球数字资产交易平台"
    },
    description: {
        ...
        message5: 'BTXCHAIN国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "BTXCHAIN是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。BTXCHAIN核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "BTXCHAIN平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "BTXCHAIN为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "BTXCHAIN严格筛选优质项目并提供安全稳定的资产托管服务。BTXCHAIN秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
    ...
    bzb_description: {
        ...
        desc4: "参与BTXCHAIN社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "BTXCHAIN账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于BTXCHAIN收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，BTXCHAIN会拿出平台的80% (扣除税费后) 的收入分配给BTXCHAIN持有者，20%的收入用来支持平台的研发及运营。",
