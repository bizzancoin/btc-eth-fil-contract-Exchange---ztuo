module.exports = {
    ...
    header: {
        ...
        lab: "创新实验室",
        ctc: "法币C2C",
        labdetail: "bizzans.com实验室  ●  共享创新成果",
        invite: "推广合伙人",
        whitepaper: "白皮书",
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于bizzans.com",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "bizzans.com由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "bizzans.com定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "bizzans.com官方新手入门辅助通道",
        oneminutebuy: "法币通道",
    ...
    ctc: {
        ...
        desc:"由bizzans.com平台托管数字资产，保障用户资产安全",
        buyin: "买入",
        sell: "卖出",
        buyprice: "买入价",
        sellprice: "卖出价",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归(bizzans.com)官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（bizzans.com）",
        tipsmobile1: "请在电脑端打开（bizzans.com）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"(bizzans.com)的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与(bizzans.com)交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，(bizzans.com)推出【推广合伙人】计划，该活动长期有效。",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由(bizzans.com)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归bizzans.com所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        identity: {
            ...
            placeholder: "请填写取消原因",
            apply: '申请成为商家',
            become: '成为bizzans.com认证商家， 享更多交易特权',
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "bizzans.comAPP - 全球数字资产交易平台"
    },
    description: {
        // message1: 'SSL、动态身份验证等银行级别安全技术，\n保障交易安全；支持多种数字货币交易',
        // message2: '严格的项目准入门槛，确保平台用户利益；\n100%保证金，钱包冷热隔离，确保用户资金安全',
        // message3: 'bizzans.com数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '金融级安全',
        title2: '极速充提',
        title3: '全球服务',
        title4: '严选资产',
        ...
        message5: 'bizzans.com国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "bizzans.com是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。bizzans.com核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "bizzans.com平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "bizzans.com为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "bizzans.com严格筛选优质项目并提供安全稳定的资产托管服务。bizzans.com秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
        ...
        apply: "上币申请",
        coop: "商务合作",
        community: "bizzans.com社区",
        wechat: "微信",
        addwechat: "添加 “bizzans.com01” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    bzb_description: {
        ...
        desc4: "参与bizzans.com社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "bizzans.com账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于bizzans.com收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，bizzans.com会拿出平台的80% (扣除税费后) 的收入分配给bizzans.com持有者，20%的收入用来支持平台的研发及运营。",
    ...
    feereturn: {
        ...
        /*time:"日期",
        todaycharge:"当日bizzans.com均价(ETH)",
