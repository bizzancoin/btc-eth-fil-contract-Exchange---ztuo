<template>
  <div class="nav-rights">
    <div class="nav-right nav_new" v-if="xsShow">
      <div class="bill_box">
        <section>
          <div class="table-inner action-box open">
            <div class="action-inner" style="display: flex;">
              <div class="inner-left">
                ...
                <Select v-model="coinType" style="width:100px;margin-top: 23px;" @on-change="changeCoin"
                  ...
                  <Option v-for="item in coinList" :value="item.coin.unit" :key="item.coin.unit">{{ item.coin.unit }}
                  </Option>
                </Select>
              </div>
              <div class="inner-box deposit-address" style="width: 50%;">
                <p class="describe">{{$t('uc.finance.recharge.address')}}</p>
                <div class="title">
                  <Input v-model="qrcode.value" readonly style="width: 280px;color:#8c979f;margin-top: 3px;"></Input>
                  <a v-show="isShowGetAddress" class="link-copy"
                    @click="resetAddress">{{$t('uc.finance.recharge.getaddress')}}</a>

                </div>
                <a id="showQRcode" class="link-qrcode" href="javascript:;" @click="showEwm"
                  style="position: absolute; right: 0;color: #f0a70a;margin-top: 5px;">
              ...
              <div class="inner-right">
                <p class="describe describe_new"><a class="withdrawcoderecharge"
                    @click="openCodeModal">{{$t('uc.finance.recharge.withdrawrecharge')}}</a></p>
              </div>
            </div>
            <div class="action-content" style="display: block;">
            ...
            <div class="xs_table">
              <div class="action-content" style="display: block; width: 160%;">
                <div class="action-body">
          ...
          <div class="table-inner action-box open">
            ...
            <div class="action-inner">
              ...
              <div class="inner-box deposit-address">
                <p class="describe">{{$t('uc.finance.recharge.address')}}</p>
                <div class="title">
                  <Input v-model="qrcode.value" readonly style="width: 400px;color:#8c979f;margin-top: 3px;"></Input>
                  <a v-show="isShowGetAddress" class="link-copy"
                    @click="resetAddress">{{$t('uc.finance.recharge.getaddress')}}</a>
                ...
                <p v-if="accountType != 0" style="margin-top: 10px;font-size:12px;color:#828ea1;">
                  ...
                  <a style="color: #f0a70a;" v-clipboard:copy="memoCode" v-clipboard:success="onCopy"
                    ...
                    class="link-copy">{{$t('uc.finance.recharge.copy')}} Memo</a>
                </p>
              </div>
              <div class="inner-right">
                <p class="describe"><a class="withdrawcoderecharge"
                    @click="openCodeModal">{{$t('uc.finance.recharge.withdrawrecharge')}}</a></p>
              </div>
            </div>
...
<style lang="scss" scoped>
  ...
  .describe_new a.withdrawcoderecharge {
    font-weight: normal;
    line-height: 30px;
    color: #f0a70a;
    width: 100px;
