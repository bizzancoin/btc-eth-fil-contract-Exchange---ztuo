export default [
    ...
    { path: '/second', component: resolve=>(require(["../pages/second/second"],resolve)) },
    { path: '/second/:pair', component: resolve=>(require(["../pages/second/second"],resolve)), name: "SecondPair"},
    ...
    },
    {
        ...
        children: [{
            ...
            {
                path: 'secondAssets',
                component: resolve=>(require(["../components/uc/SecondAssets"],resolve))
            },
            {
                path: 'financeAssets',
