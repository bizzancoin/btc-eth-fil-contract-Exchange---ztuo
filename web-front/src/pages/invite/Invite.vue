...
<!--          <p>{{$t('invite.ruletext10')}}</p>-->
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/2019/08/08/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/2019/08/08/invitebg.jpg"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/2019/08/08/promotioncard.png"></img>
        <div class="desc">
      ...
      <div class="ptcard-info">
        ...
        <p class="detail">{{$t('invite.pt_card_rule1')}}：promotion@bizzans.com。</p>
  ...
  data() {
    ...
    return {
      ...
      myInfo: {
        ...
        extrareward: 0,
        partnerlevel: "-",
        inviteLink: "https://www.bizzans.com/register?code=000000"
      },
      promotionRecordPage: {
        pageNo: 1,
        pageSize: 10
