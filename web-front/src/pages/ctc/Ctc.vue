                      ...
                      <div class="bd bd_limited">
                        <Form>
                          ...
                          <FormItem class="trade-input">
                            ...
                            <InputNumber style="width:70%;float:right;" v-model="buyAmount"  size="large" :max="50000" :min="50" :active-change="false" :placeholder="$t('ctc.input50tips')"></InputNumber>
                      ...
                      <div class="bd bd_limited">
                        <Form ref="formValidate">
                          ...
                          <FormItem class="trade-input">
                            ...
                            <InputNumber style="width:70%;float:right;" v-model="sellAmount" size="large" :max="50000" :min="50" :active-change="false" :placeholder="$t('ctc.input50tips')"></InputNumber>
                            <label class="after">USDT</label>
                          </FormItem>
