  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">PEPSICOIN</p>
    ...
    <div class="section" id="page4">
      <ul>
        <li>
          <div><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/btx/download1.png" alt=""></div>
          <p class="title">Extreme Experience</p>
          <p>Meticulously optimized interface display, experience smooth operation response</p>
        </li>
        <li>
          <div><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/btx/download2.png" alt=""></div>
          <p class="title">Currency Quotes</p>
          <p>Support MACD, KDJ, RSI, BOLL and other professional indicators</p>
        </li>
        <li>
          <div><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/btx/download5.png" alt=""></div>
          <p class="title">Currency Transaction</p>
          <p>Support two methods of limit order and market order</p>
        </li>
        <li>
          <div><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/btx/download3.png" alt=""></div>
          <p class="title">Fiat currency transaction</p>
          <p>Quality acceptors, to ensure the smooth flow of funds</p>
        </li>
        <li>
          <div><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/btx/download4.png" alt=""></div>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/btx/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "zh_CN" ? "APP下载 - " : "APP Download - ") + "PEPSICOIN | Global digital currency trading platform";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://bizzanss.oss-cn-hangzhou.aliyuncs.com/pepsi.apk";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
