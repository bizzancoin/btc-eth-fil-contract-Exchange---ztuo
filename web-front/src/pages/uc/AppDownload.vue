  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">BTXCHAIN</p>
    ...
    <div class="section" id="page4">
      <ul>
       <!-- <li>
          <div><img src="https://bzeex.oss-cn-hongkong.aliyuncs.com/2019/08/08/download1.png" alt="" /></div>
          <p class="title">Extreme Experience</p>
          <p>Meticulously optimized interface display, experience smooth operation response</p>
        </li>
        <li>
          <div><img src="https://bzeex.oss-cn-hongkong.aliyuncs.com/2019/08/08/download2.png" alt="" /></div>
          <p class="title">Currency Quotes</p>
          <p>Support MACD, KDJ, RSI, BOLL and other professional indicators</p>
        </li>
        <li>
          <div><img src="https://bzeex.oss-cn-hongkong.aliyuncs.com/2019/08/08/download5.png" alt="" /></div>
          <p class="title">Currency Transaction</p>
          <p>Support two methods of limit order and market order</p>
        </li>
        <li>
          <div><img src="https://bzeex.oss-cn-hongkong.aliyuncs.com/2019/08/08/download3.png" alt="" /></div>
          <p class="title">Fiat currency transaction</p>
          <p>Quality acceptors, to ensure the smooth flow of funds</p>
        </li>
        <li>
          <div><img src="https://bzeex.oss-cn-hongkong.aliyuncs.com/2019/08/08/download4.png" alt="" /></div>
    ...
    <div class="cover" id="cover" @click="coverClick">
      <img src="https://bzeex.oss-cn-hongkong.aliyuncs.com/2019/08/08/appdowncover.png" />
    </div>
  </div>
</template>
  ...
  methods: {
    init() {
      window.document.title =
        (this.lang == 'zh_CN' ? 'APP下载 - ' : 'APP Download - ') + 'BTXCHAIN | Global digital currency trading platform'
      this.getVersion()
    },
    downloadClick() {
      if (this.isWeiXin()) {
        ...
        location.href = 'https://bzeex.oss-cn-hongkong.aliyuncs.com/app.apk'
      }
    },
    downloadClick2() {
      if (this.isWeiXin()) {
